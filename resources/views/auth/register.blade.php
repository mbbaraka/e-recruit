          ...
          <div class="login-wrapper my-auto">
            ...
            <form action="{{ route('register') }}" method="POST">
              ...
              <div class="form-group mb-4">
                ...
                <input type="password" name="password_confirmation" id="password" class="form-control @error('password') is-invalid @enderror" placeholder="enter your passsword">
                @error('password')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
            ...
            <p class="login-wrapper-footer-text">Already registered? <a href="{{ route('login') }}" class="text-reset">Login here</a></p>
          </div>
        </div>
